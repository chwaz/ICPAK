				...
				<table class="table table-hover">
					...
					<tbody>
						<?php if ($firms_records != NULL){ 
							generate_tables($firms_records);
						 }else{	
		...
		<script  type="text/javascript" charset="utf-8">
			$(document).ready(function(){    
				...
				/*$('#contactForm').on('submit',function(e){
					...
					var advancedSearchPost=$.post('<?php echo base_url(); ?>index.php/firms/advanced',
						{
							Address:$('#address2').val(),
							Partners:$('#partners').val(),
							Typeoffirm:$('#typeofirm').val()
						});
					advancedSearchPost.done(function(data){
						var_dump(data);
					});
				});*/
